...
workload_arr = ["fillrandom", "readrandom"]
...
base_dir_template = f"{output_dir}/leveldb/figure13/{{config}}/result.txt"
...
def extract_and_round_ops_per_sec(line, operation_type):
    ...
    if match:
        ...
        rounded_ops_per_sec = round(ops_per_sec, 2)
        return rounded_ops_per_sec
    else:
        return None
