...
workload_arr = ["seqread", "seqwrite", "randread", "randwrite"]
config_arr = ["nova", "fusionfs", "hostcache", "lambdaio-emulate", "omnicache"]
config_out_arr = ["NOVA", "FusionFS", "HostCache-user-level", "lambda-IO-emulate", "OmniCache"]
readsize_arr = ["128"]
